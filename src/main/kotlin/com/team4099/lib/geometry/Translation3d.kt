...
class Translation3d(val m_x: Length, val m_y: Length, val m_z: Length) {
  constructor(translation3d: External): this(
  ...
  fun getDistance(other: Translation3d) : Length {
    ...
    return Math.sqrt((dist.m_x*dist.m_x.inMeters + dist.m_y*dist.m_y.inMeters + dist.m_z*dist.m_z.inMeters)/1.meters).meters
  }
