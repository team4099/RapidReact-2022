...
object RobotContainer {
  ...
  fun mapTeleopControls() {
    ...
    ControlBoard.startClimbSequence.whileActiveOnce(UseLowThresholdClimbCommand(pneumatic).alongWith(ResetGyroPitchCommand(drivetrain).andThen(ClimbSequenceCommand(telescopingClimber, pivotClimber))))
